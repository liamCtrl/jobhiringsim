...
func awvap():
	...
	$ReqList/reqExperienceLabel.set_text(strExperiences)
	...
	$ReqList/reqSkillLabel.set_text(strSkills)
	...
	$ReqList/reqEducationLabel.set_text(strEducation)
	$ReqList/jobTitleLabel.set_text("Associate Wrothinx Vrunian Askroop Programmer")
func intern():
	...
	var strEducation = array_to_string(education)
	$ReqList/reqEducationLabel.set_text(strEducation)
	$ReqList/jobTitleLabel.set_text("Unpaid Intern")
func crueo():
	...
	var strEducation = array_to_string(education)
	$ReqList/reqEducationLabel.set_text(strEducation)
	$ReqList/jobTitleLabel.set_text("Chief Royal Unskian Entertainment Officer")
func mssmthceuue():
	...
	var strEducation = array_to_string(education)
	$ReqList/reqEducationLabel.set_text(strEducation)
	$ReqList/jobTitleLabel.set_text("Martian Surface Sanitation and Maintenance Technician for Habitat Cleanliness and Environmental Upkeep for the Unskian Empire")
func seisam():
	var experiences = ["20 Years of Experience with Corporate Greed Systems",
	...
	var strEducation = array_to_string(education)
	$ReqList/reqEducationLabel.set_text(strEducation)
	$ReqList/jobTitleLabel.set_text("Senior Extraterrestrial Interstellar Space Advertisement Manager")
